...
export class InitialSchema1637899309879 implements MigrationInterface {
  name = 'InitialSchema1637899309879';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`companies\` (\`description_company\` varchar(500) NOT NULL, \`img_company\` varchar(500) NOT NULL, \`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`name_company\` varchar(30) NOT NULL, \`email\` varchar(150) NOT NULL, \`password\` varchar(15) NOT NULL, UNIQUE INDEX \`UQ_company\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`announcement\` (\`title\` varchar(250) NOT NULL, \`description\` varchar(500) NOT NULL, \`specialty\` varchar(150) NOT NULL, \`experience\` varchar(100) NOT NULL, \`visible\` int NOT NULL, \`onlyPractitioner\` int NOT NULL, \`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`salary\` decimal(7,2) NOT NULL, \`currency\` varchar(5) NOT NULL, \`date\` date NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`payments\` (\`charge_amount\` int NOT NULL, \`company\` varchar(70) NOT NULL, \`Payment_Option\` varchar(20) NOT NULL, \`suscriptions\` varchar(150) NOT NULL, \`payment_date\` varchar(500) NOT NULL, \`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
  }
